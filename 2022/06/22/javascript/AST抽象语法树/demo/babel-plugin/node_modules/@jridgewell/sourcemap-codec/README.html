<h1 id="sourcemap-codec"><a href="#sourcemap-codec" class="headerlink" title="sourcemap-codec"></a>sourcemap-codec</h1><p>Encode/decode the <code>mappings</code> property of a <a href="https://docs.google.com/document/d/1U1RGAehQwRypUTovF1KRlpiOFze0b-_2gc6fAH0KY0k/edit">sourcemap</a>.</p>
<h2 id="Why"><a href="#Why" class="headerlink" title="Why?"></a>Why?</h2><p>Sourcemaps are difficult to generate and manipulate, because the <code>mappings</code> property – the part that actually links the generated code back to the original source – is encoded using an obscure method called <a href="https://en.wikipedia.org/wiki/Variable-length_quantity">Variable-length quantity</a>. On top of that, each segment in the mapping contains offsets rather than absolute indices, which means that you can’t look at a segment in isolation – you have to understand the whole sourcemap.</p>
<p>This package makes the process slightly easier.</p>
<h2 id="Installation"><a href="#Installation" class="headerlink" title="Installation"></a>Installation</h2><pre><code class="bash">npm install sourcemap-codec
</code></pre>
<h2 id="Usage"><a href="#Usage" class="headerlink" title="Usage"></a>Usage</h2><pre><code class="js">import { encode, decode } from &#39;sourcemap-codec&#39;;
...
<h2 id="Benchmarks"><a href="#Benchmarks" class="headerlink" title="Benchmarks"></a>Benchmarks</h2><pre><code>node v18.0.0
