...
<h2 id="Usage"><a href="#Usage" class="headerlink" title="Usage"></a>Usage</h2><pre><code class="js">const isNumber = require(&#39;is-number&#39;);
</code></pre>
<p>See the <a href="./test.js">tests</a> for more examples.</p>
<h3 id="true"><a href="#true" class="headerlink" title="true"></a>true</h3><pre><code class="js">isNumber(5e3);               // true
isNumber(0xff);              // true
isNumber(-1.1);              // true
isNumber(0);                 // true
isNumber(1);                 // true
...
<h3 id="False"><a href="#False" class="headerlink" title="False"></a>False</h3><p>Everything else is false, as you would expect:</p>
...
<h2 id="Release-history"><a href="#Release-history" class="headerlink" title="Release history"></a>Release history</h2><h3 id="7-0-0"><a href="#7-0-0" class="headerlink" title="7.0.0"></a>7.0.0</h3><ul>
...
<h3 id="6-0-0"><a href="#6-0-0" class="headerlink" title="6.0.0"></a>6.0.0</h3><ul>
<li>Optimizations, thanks to @benaadams.</li>
</ul>
<h3 id="5-0-0"><a href="#5-0-0" class="headerlink" title="5.0.0"></a>5.0.0</h3><p><strong>Breaking changes</strong></p>
<ul>
<li>removed support for <code>instanceof Number</code> and <code>instanceof String</code></li>
</ul>
<h2 id="Benchmarks"><a href="#Benchmarks" class="headerlink" title="Benchmarks"></a>Benchmarks</h2><p>As with all benchmarks, take these with a grain of salt. See the <a href="./benchmark/index.js">benchmarks</a> for more detail.</p>
<pre><code># all
...
<h3 id="License"><a href="#License" class="headerlink" title="License"></a>License</h3><p>Copyright © 2018, <a href="https://github.com/jonschlinkert">Jon Schlinkert</a>.<br>Released under the <a href="LICENSE">MIT License</a>.</p>
<hr>
